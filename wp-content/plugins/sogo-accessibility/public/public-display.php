...
<a id="open_sogoacc"
   title="<?php echo esc_attr( __( 'Press "Alt + A" to open\close the accessibility menu', 'sogoacc' ) ) ?>"
   tabindex="1"
    ...
    <div class="sogo-btn-toolbar" role="toolbar">
        ...
        <div class="accessibility-info">
            ...
            <div><a title="<?php echo esc_attr( __( 'cancel accessibility', 'sogoacc' ) ) ?>" id="sogo_accessibility"
                    href="#"><i class="fa fa-times-circle-o red"></i><?php _e( 'cancel accessibility', 'sogoacc' ) ?>
                </a>
            </div>
            <div>
				<?php
				...
				<?php else: ?>
                    <a title="<?php echo esc_attr( __( 'Accessibility Statement', 'sogoacc' ) ) ?>"
                       href="<?php echo esc_url( $tac_link ) ?>"><i
                                class="fa fa-info-circle green"></i><?php _e( 'Accessibility Statement', 'sogoacc' ) ?>
                    </a>
				<?php endif; ?>
            </div>
