...
function twentythirteen_setup() {
	...
	//miniatura interna do post
	add_image_size('post-thumbnail', 1600, 700, true);

	//miniatura principal destaque mosaico-homepage
	add_image_size('thumb-destaque-mosaico', 644, 485, true);
...
function twentythirteen_widgets_init() {
	...
	register_sidebar( array(
		'name'			=> __('Logo Widget', 'twentythirteen'),
		'id'			=> 'sidebar-logo',
		'description'	=> __('Widget aparece na barra de navegação(Logo NavBar).', 'twentythirteen'),
		'before_widget'	=> '<div class="logo-cultura">',
		'after_widget'	=> '</div>',
		'before_title'	=> '<h3 class="widget-title">',
		'after_title'	=> '</h3>',
	) );
